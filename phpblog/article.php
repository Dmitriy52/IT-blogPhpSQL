          ...
          <section class="content__left col-md-8">
            <div class="block">
              ...
              <div class="block__content">
                <div class="full-text">
                     Запрашиваемая Втатья не существует
                </div>
              </div>
            </div>
                              ...
                              <section class="content__left col-md-8">
                                <div class="block">
                                  ...
                                  <div class="block__content">
                                    ...
                                    <div class="full-text" style="word-wrap: break-word;">  <?php echo $art['text']; ?> </div>
                                  </div>
                                  </div>
                                            ...
                                            <?php   //Find errors
                                                if(isset($_POST['do_post']) ){
                                                    ...
                                                    if (empty($errors)){
                                                        ...
                                                        mysqli_query($connection, "INSERT INTO `comments` (`author`, `nick_name`, `email`, `text`, `article_id`) VALUES ('".$_POST['name']."', '".$_POST['nickname']."', '".$_POST['email']."', '".$_POST['text']."', '".$art['id']."')");
